...
/* === MIDI EXPORT FUNCTIONS (Multi-Track Format 1) === */
...
const TRACK_CONFIG = {
  ...
  pad: { channel: 1, name: 'Pad/Harmony', octave: 3 },
...
// Main MIDI export function - exports both patterns A and B with separate tracks
function exportPatternToMIDI() {
  ...
  downloadMIDIFile(midiData, '8bit-loop-AB.mid');
}
